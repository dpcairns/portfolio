...
export default {
  [LOCALES.SPANISH]: {
    ...
    paragraph1: `Mi nombre es Surelis Segarra. En 2017 me mudé de Puerto Rico debido
        ...
        nueva vida y durante este proceso hice la mayor transición
        y comencé a estudiar desarrollo de software.`,
    paragraph2: `Como desarrolladora front-end, me fascina expresar mi
        creatividad a través de hermosas aplicaciones funcionales. Disfruto trabajando en
        entornos colaborativos y busco unirme a un equipo para poner mis habilidades
        en la planificación, implementación, análisis y resolución de problemas en uso.`,
    paragraph3:
    ...
    emailNotSent: "Correo Electrónico  No Enviado",
  },
};
